...
import { 
  Square,      // instead of Facebook
  SquareDot,   // instead of Github
  SquareMinus, // instead of Linkedin
  SquareEqual, // instead of Slack
  SquarePlus   // instead of Youtube
} from "lucide-react";
...
const socialLink = [
  ...
  },
  {
    title: "Linkedin",
    href: "https://www.youtube.com/@reactjsBD",
    icon: <SquareMinus className="w-5 h-5" />,
  },
  {
    title: "Facebook",
    href: "https://www.youtube.com/@reactjsBD",
